...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Answer:
    # Inject iterates over the members of an array. While doing so, it performs the block 
    # function on each subsequent value within the array. The argument is the 
    # initial value on which the block function is performed.
    #
    # [a, r, r, a, y].inject(arg) { |x, y| <block> }
    #
  ...
  # I DUNNO?  Look for the answers in the future.
